...
export function RequestsProvider({ children }: { children: React.ReactNode }) {
  ...
  const value = useMemo(
    () => ({ requests, requestsLoaded, requestsRefreshing, refreshRequests: loadRequests, addRequests, updateRequest, cancelRequest }),
    [requests, requestsLoaded, requestsRefreshing, loadRequests, addRequests, updateRequest, cancelRequest],
  );
